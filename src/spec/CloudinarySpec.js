describe("cloudinary", function() {
  ...
  it("should use x, y, radius, prefix, gravity and quality from options", function() {    
    ...
    result = $.cloudinary.url_internal("test", options);
    expect(options).toEqual({});
    expect(result).toEqual("http://res.cloudinary.com/test123/image/upload/g_center,p_a,q_0.4,r_3,x_1,y_2/test") ;
  });
  ...
  it("should support fetch_image", function() {
    ...
    expect(result).toEqual("http://res.cloudinary.com/test123/image/fetch/http://example.com/hello.jpg%3Fa%3Db") 
  });
  ...
  it("should support opacity", function() {
    ...
    result = $.cloudinary.url_internal("test", options);
    expect(options).toEqual({});
    expect(result).toEqual("http://res.cloudinary.com/test123/image/upload/o_30/test");
  });
